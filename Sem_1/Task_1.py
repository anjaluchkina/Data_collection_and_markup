"""- использовать библиотеку requests в Python для отправки запросов GET, POST, PUT и DELETE на конечную точку REST API
...
Инструкции:
можно использовать предоставленный код в качестве
отправной точки для своего решения."""
...
data = {"title": "Work Anna", "body": "Scraping", "userId": 1}
