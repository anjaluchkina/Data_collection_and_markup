...
# Используются XPath выражения для поиска заголовков видео и метаданных (например, количества просмотров и времени публикации)
    ...
    print(video_data)
# собираются данные о каждом видео. 
# Если метаданные содержат "•", они разбиваются на две части - количество просмотров и время публикации. 
# Если нет, устанавливается "Неизвестно" для времени
